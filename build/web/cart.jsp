...
<!--                <h4>Tổng số tiền: <fmt:setLocale value = "en_US"/>
                    <fmt:formatNumber value = "${total}" type = "currency"/></h4>-->
...
<!--
            ...
            <input type="submit" value="Tiến hành thanh toán"/>
               ...
               <a href="checkout.jsp" class="aa-cart-view-btn">Thanh toán</a>
             </div>
            </div>
            <a href="home"><button type="button" class="btn btn-primary">Home</button>
