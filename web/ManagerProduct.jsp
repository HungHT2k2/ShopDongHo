                    ...
                    <form action="add" method="get">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input name="timepin" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>HÐH</label>
                                <input name="hdh" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Hãng</label>
                ...
                <div class="modal-content">
                    <form action="add" method="get">
                        ...
                        <div class="modal-body">
                             ...
                             <div class="form-group">
                                <label>Category da ton tai:</label>
                                <select name="category" class="form-select" aria-label="Default select example">
                                    <c:forEach items="${listCC}" var="o">
                                        <option value="${o.categoryID}">${o.name}</option>
                                    </c:forEach>
                            ...
                            <div class="form-group">
                                ...
                                <input name="categorynew:" type="text" class="form-control" required>
                            </div>
       
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                            <input type="#" class="btn btn-success" value="Add Category">
                        </div>
                    </form>
                </div>
            </div>
